!(() => {
  ...
  function u(e, t) {
    return (u = Object.setPrototypeOf || ((e, t) => ((e.__proto__ = t), e)))(e, t);
  }
  function d(e, t) {
    return u(e, t);
  }
  ...
  function p(e) {
    for (var t = 1; t < arguments.length; t++) {
      ...
      'function' == typeof Object.getOwnPropertySymbols &&
        (n = n.concat(Object.getOwnPropertySymbols(r).filter(e => Object.getOwnPropertyDescriptor(r, e).enumerable))),
        n.forEach(t => {
          l(e, t, r[t]);
        });
    }
  ...
  function C(e) {
    return (C = Object.setPrototypeOf ? Object.getPrototypeOf : e => e.__proto__ || Object.getPrototypeOf(e))(e);
  }
  function S(e) {
    return C(e);
  }
  ...
  var z = {},
    E = (e => {
      ...
      return (
        ...
        (e.isGeneratorFunction = e => {
          var t = 'function' == typeof e && e.constructor;
          return !!t && (t === m || 'GeneratorFunction' === (t.displayName || t.name));
        }),
        (e.mark = e => (
          Object.setPrototypeOf ? Object.setPrototypeOf(e, _) : ((e.__proto__ = _), c(e, s, 'GeneratorFunction')),
        ...
        (e.async = (t, r, n, o, i) => {
          ...
          return e.isGeneratorFunction(r) ? a : a.next().then(e => (e.done ? e.value : a.next()));
        }),
        x(w),
        c(w, s, 'Generator'),
        c(w, i, function () {
  ...
  function U(e, t, r) {
    ...
    if (
      (arguments.length > 2 && (a.children = arguments.length > 3 ? P.call(arguments, 2) : r),
  ...
  function $(e) {
    ((!e.__d && (e.__d = !0) && B.push(e) && !X.__r++) || T !== R.debounceRendering) &&
      ((T = R.debounceRendering) || A)(X);
  }
  function X() {
    for (var e; (X.__r = B.length); )
      (e = B.sort((e, t) => e.__v.__b - t.__v.__b)),
        (B = []),
        e.some(e => {
          var t, r, n, o, i, a;
          e.__d &&
  ...
  function Y(e, t, r, n, o, i, a, s, c, l) {
    ...
    for (r.__k = [], u = 0; u < t.length; u++)
      if (
        ...
        if (((p.__ = r), (p.__b = r.__b + 1), null === (h = m[u]) || (h && p.key == h.key && p.type === h.type)))
          m[u] = void 0;
        else
          for (d = 0; d < _; d++) {
    ...
    for (r.__e = v, u = _; u--; )
      null != m[u] &&
        ('function' == typeof r.type && null != m[u].__e && m[u].__e == r.__d && (r.__d = G(n, u + 1)), se(m[u], m[u]));
    if (g) for (u = 0; u < g.length; u++) ae(g[u], g[++u], g[++u]);
  }
  function J(e, t, r) {
    for (var n, o = e.__k, i = 0; o && i < o.length; i++)
      (n = o[i]) && ((n.__ = e), (t = 'function' == typeof n.type ? J(n, t, r) : Q(r, n, n, o, n.__e, t)));
    return t;
  }
  function Z(e, t) {
    return (
        ...
        if (
          ...
          r.__c
            ...
            : ('prototype' in y && y.prototype.render
                ? (t.__c = u = new y(g, _))
                : ((t.__c = u = new W(g, _)), (u.constructor = y), (u.render = ce)),
              m && m.sub(u),
              (u.props = g),
              u.state || (u.state = {}),
              (u.context = _),
          ...
          null != y.getDerivedStateFromProps &&
            (u.__s == u.state && (u.__s = F({}, u.__s)), F(u.__s, y.getDerivedStateFromProps(g, u.__s))),
          (h = u.props),
          (p = u.state),
          d)
        )
          ...
          if (
            ...
            (!u.__e && null != u.shouldComponentUpdate && !1 === u.shouldComponentUpdate(g, u.__s, _)) ||
              t.__v === r.__v)
          ) {
            (u.props = g),
              (u.state = u.__s),
          ...
          : (t.__e = ((e, t, r, n, o, i, a, s) => {
              ...
              if (null === p) d === h || (s && e.data === h) || (e.data = h);
                ...
                s ||
                  ('value' in h &&
                    void 0 !== (f = h.value) &&
                    (f !== d.value || f !== e.value || ('progress' === p && !f)) &&
    ...
    return (
      ...
      e
        ...
        : t &&
          !Ee &&
          console.warn(
            '`'.concat(t, '` requires data to be initialized first. Promise will be pending until `init` is called.')
          ),
      Me
    );
  }
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                ...
                case 33:
                  ...
                  break;
                case 36:
                  Ce.categories = Ce.categories.filter(e => !!!e.name);
                case 37:
                ...
                case 50:
                  return (
                    (e.next = 52), je('https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/'.concat(i, '.json'))
                  );
                case 52:
                  e.t6 = e.sent;
                case 53:
                ...
                case 87:
                  r.categories &&
                    (Ce.categories = Ce.originalCategories
                      .filter(e => -1 != r.categories.indexOf(e.id))
                      .sort((e, t) => r.categories.indexOf(e.id) - r.categories.indexOf(t.id))),
                    (_ = null),
                    (y = null),
                      ...
                      [
                        ...
                        .flatMap(e => {
                          var t = b(e, 2),
                            ...
                            n = t[1];
                          if (r)
                            return (Array.isArray(r) ? r : [r]).flatMap(e =>
                              (n ? e.split(/[-|_|\s]+/) : [e]).map(e => e.toLowerCase())
                            );
                        })
                        .filter(e => e && e.trim())
                        .join(',')),
                ...
                case 153:
                  D++,
                    (G = W.native) && ((Ce.natives[G] = P.id), (P.search += ','.concat(G))),
  ...
  function Ae(e, t, r, n) {
    ...
    return o
      ? (null != i &&
          ...
          (i = 'boolean' == typeof o.value ? 'false' != i : o.value.constructor(i)),
                  ...
                  case 6:
                    if (
                      (a = r
                        ...
                        .replace(/(\w)-/, '$1 ')
                        .split(/[\s|,]+/)
                        .filter((e, t, r) => e.trim() && r.indexOf(e) == t)).length
                    ) {
                      e.next = 9;
                      break;
                    }
  ...
  var Ie = {
      ...
      get: e => (e.id ? e : Ce.emojis[e] || Ce.emojis[Ce.aliases[e]] || Ce.emojis[Ce.natives[e]]),
      reset: () => {
        Te = null;
      },
  ...
  var Ze = (e => {
              ...
              value: function (e, t, r) {
                if (this.component) {
                  ...
                  this.component.componentWillReceiveProps
                    ...
                    : ((this.component.props[e] = n), this.component.forceUpdate());
                }
              },
            },
            {
    ...
    et = {
      ...
      native: '',
      shortcodes: '',
      size: { value: '', transform: e => (/\D/.test(e) ? e : ''.concat(e, 'px')) },
      set: we.set,
      skin: we.skin,
    },
    tt = (e => {
  ...
  function ut() {
    var e;
    for (ot.sort((e, t) => e.__v.__b - t.__v.__b); (e = ot.pop()); )
      if (e.__P)
        try {
  ...
  (R.__b = e => {
    ...
    (R.__c = (e, t) => {
      t.some(e => {
        try {
          e.__h.forEach(ht), (e.__h = e.__h.filter(e => !e.__ || pt(e)));
        } catch (r) {
          t.some(e => {
            e.__h && (e.__h = []);
          }),
  ...
  (R.unmount = e => {
    ...
    ((yt.prototype = new W()).__c = function (e, t) {
      var r = t.__c;
      null == this.t && (this.t = []), this.t.push(r);
      var o = kt(this.__v),
        i = !1,
        a = () => {
      ...
      var s = () => {
          if (!--this.__u) {
            if (this.state.__e) {
              var e = this.state.__e;
              this.__v.__k[0] = (function e(t, r, n) {
                return (
                  t &&
                    ((t.__v = null),
                    (t.__k = t.__k && t.__k.map(t => e(t, r, n))),
                    t.__c &&
                      t.__c.__P === r &&
            ...
            var t;
            for (this.setState({ __e: (this.__b = null) }); (t = this.t.pop()); ) t.forceUpdate();
          }
        },
        c = !0 === t.__h;
      this.__u++ || c || this.setState({ __e: (this.__b = this.__v.__k[0]) }), e.then(a, a);
    }),
  ...
  ((wt.prototype = new W()).__e = function (e) {
    ...
    return (
      ...
      o => {
        var i = () => {
          this.props.revealOrder ? (n.push(o), xt(this, e, n)) : o();
        };
        r ? r(i) : i();
      }
    );
  ...
  R.event = e => (
    Lt && (e = Lt(e)), (e.persist = Mt), (e.isPropagationStopped = zt), (e.isDefaultPrevented = Et), (e.nativeEvent = e)
  );
  var Pt = {
      configurable: !0,
      get: function () {
  ...
  R.vnode = e => {
    ...
    if ('string' == typeof r) {
            ...
            : 'download' === a && !0 === s
              ...
              : /ondoubleclick/i.test(a)
                ...
                : /^onchange(textarea|input)/i.test(a + r) &&
                    ((t = n.type),
                    !('undefined' != typeof Symbol && 'symbol' == j(Symbol()) ? /fil|che|rad/i : /fil|che|ra/i).test(t))
                  ? (a = 'oninput')
                  : /^onfocus$/i.test(a)
                    ? (a = 'onfocusin')
                    : /^onblur$/i.test(a)
      ...
      'select' == r &&
        ...
        (o.value = Z(n.children).forEach(e => {
  ...
  var Bt = { light: 'outline', dark: 'solid' },
    At = (e => {
      ...
      function r() {
        ...
        return (
          a(this, r),
          ((e = t.call(this)).categories = Ce.categories.filter(e => !e.target)),
            ...
            value: function () {
              ...
              return de('nav', {
                ...
                children: de('div', {
                  class: 'flex relative',
                  children: [
                    this.categories.map((r, n) => {
                      var o = this,
                        i = r.name || xe.categories[r.id],
                        a = !this.props.unfocused && r.id == this.state.categoryId;
                      return (
                        a && (t = n),
                        de('button', {
                          'aria-label': i,
    ...
    It = (e => {
      ...
      function o(e) {
        var s;
        a(this, o),
          l(n((s = r.call(this))), 'darkMediaCallback', () => {
            'auto' == s.props.theme && s.setState({ theme: s.darkMedia.matches ? 'dark' : 'light' });
          }),
          l(n(s), 'handleClickOutside', e => {
            var t = s.props.element;
            e.target != t && (s.state.showSkins && s.closeSkins(), s.props.onClickOutside && s.props.onClickOutside(e));
          }),
          l(n(s), 'handleBaseClick', e => {
            s.state.showSkins &&
              (e.target.closest('.menu') || (e.preventDefault(), e.stopImmediatePropagation(), s.closeSkins()));
          }),
          l(n(s), 'handleBaseKeydown', e => {
            s.state.showSkins &&
              'Escape' == e.key &&
              (e.preventDefault(), e.stopImmediatePropagation(), s.closeSkins());
          }),
          l(n(s), 'handleSearchClick', () => {
        ...
        return (
                  ...
                  e => {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 10:
                          for (
                            a = r.selectionStart == r.value.length ? [0, 0] : [-1, -1],
                              (s = []).setsize = o.length,
                              l = null,
                              u = !0,
                              d = !1,
                            ...
                            (v = f.value),
                              (s.length && l.length != c.getPerLine()) ||
                                (((l = []).__categoryId = 'search'), (l.__index = s.length), s.push(l)),
                              l.push(v);
                          e.next = 23;
                          break;
                        case 19:
          ...
          (s.observers = []),
          (s.state = p(
            { pos: [-1, -1], perLine: s.initDynamicPerLine(e), visibleRows: { 0: !0 } },
            s.getInitialState(e)
          )),
          s
        );
        ...
        c(o, [
            ...
            value: function (e) {
              ...
              clearTimeout(this.nextStateTimer),
                (this.nextStateTimer = setTimeout(() => {
                  var e = !1;
                  for (var r in this.nextState)
                    (this.props[r] = this.nextState[r]), ('custom' !== r && 'categories' !== r) || (e = !0);
                  delete this.nextState;
                  var n = this.getInitialState();
                  if (e) return this.reset(n);
                  this.setState(n);
                }));
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              document.removeEventListener('click', this.handleClickOutside),
                null === (e = this.darkMedia) ||
                  void 0 === e ||
                  e.removeEventListener('change', this.darkMediaCallback),
                this.unobserve();
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              var r = Ce.categories.map(e => e.id).join(',');
              ...
              var n = (t, r) => {
                  var n = [];
                  (n.__categoryId = r.id), (n.__index = t.length), this.grid.push(n);
                  var o = this.grid.length - 1,
                    i = o % Ht ? {} : { current: null };
                  return (i.index = o), (i.posinset = this.grid.setsize + 1), t.push(i), n;
                },
                o = !0,
                i = !1,
                a = void 0;
          ...
          },
          {
            key: 'observeRows',
            value: function () {
              var t = p({}, this.state.visibleRows),
                r = new IntersectionObserver(
                  r => {
                    ...
                    try {
                      for (var a, s = r[Symbol.iterator](); !(n = (a = s.next()).done); n = !0) {
                        var c = a.value,
                          l = Number.parseInt(c.target.dataset.index);
                ...
                var l = b(this.state.pos, 2),
                  ...
                  h = (() => {
                    ...
                    if (n || o) {
                      ...
                      if (!e[(d += s)]) {
                        if (!(e = c[(u += s)]))
                          return (u = n ? 0 : c.length - 1), (d = n ? 0 : c[u].length - 1), [u, d];
                        d = n ? e.length - 1 : 0;
                      }
                      return [u, d];
                    }
                    if (i || a) {
                      ...
                      return l
                        ...
                        : ((u = i ? 0 : c.length - 1), (d = i ? 0 : c[u].length - 1), [u, d]);
                    }
                  })();
                h
                  ? (t.preventDefault(),
                    this.setState({ pos: h, keyboard: !0 }, () => {
                      this.scrollTo({ row: h[0] });
                    }))
            ...
            value: function (e) {
              ...
              if (n.length) {
                ...
                if ((r >= 0 && (t = n[r].__categoryId), t))
                  a =
                    (this.refs[t] || this.refs.categories.get(t).root).current.getBoundingClientRect().top -
                    (i.top - o.scrollTop) +
                    1;
                if (r >= 0)
                  if (r) {
                        ...
                        children: de(Ge, {
                          ...
                          id: t
                            ...
                            : this.props.previewEmoji ||
                              ('top' == this.props.previewPosition ? 'point_down' : 'point_up'),
                          set: this.props.set,
            ...
            value: function (e, t) {
              var r,
                ...
                d =
                  ((r = this.state.pos),
                  (n = o),
                  Array.isArray(r) && Array.isArray(n) && r.length === n.length && r.every((e, t) => e == n[t])),
              ...
              return de(
                Tt,
                {
                  ...
                  children: de('button', {
                    ...
                    onMouseEnter: () => this.handleEmojiOver(o),
                      ...
                      de('div', {
                        ...
                        style: {
                          ...
                          backgroundColor: this.props.emojiButtonColors
                            ? this.props.emojiButtonColors[(i - 1) % this.props.emojiButtonColors.length]
                            : void 0,
                        },
                      }),
                      de(Ge, {
                        ...
                        children: t.length
                          ...
                          : de('div', {
                              ...
                              children:
                                ...
                                de('a', { onClick: this.props.onAddCustomEmoji, children: xe.add_custom }),
                            }),
                      }),
                    ],
                  })
          ...
          },
          {
            ...
            value: function () {
              ...
              return de('div', {
                ...
                children: t.map(t => {
                  var r = this,
                    o = this.refs.categories.get(t.id),
                    i = o.root,
                    a = o.rows;
                  return de('div', {
                    ...
                    children: [
                      ...
                      de('div', {
                        class: 'relative',
                        style: { height: a.length * this.props.emojiButtonSize },
                        children: a.map((e, o) => {
                          var i,
                            a = r,
                              ...
                              'div',
                              {
                                ...
                                children:
                                  ...
                                  h.map((t, r) => {
                                    if (!t)
                                      return de('div', {
                                        style: { width: a.props.emojiButtonSize, height: a.props.emojiButtonSize },
                                      });
                                    var n = Ie.get(t);
          ...
          },
          {
            key: 'renderSkins',
            value: function () {
              var t = this.refs.skinToneButton.current.getBoundingClientRect(),
                r = this.base.getBoundingClientRect(),
                n = {};
              return (
                'ltr' == this.dir ? (n.right = r.right - t.right - 3) : (n.left = t.left - r.left - 3),
                'bottom' == this.props.previewPosition && 'preview' == this.props.skinTonePosition
                    ...
                    return de('div', {
                      children: [
                        de('input', {
                          ...
                          defaultChecked: o,
                          onChange: () => r.handleSkinMouseOver(n),
                          onKeyDown: e => {
                            ('Enter' != e.code && 'Space' != e.code && 'Tab' != e.code) ||
                        ...
                        de('button', {
                          'aria-hidden': 'true',
                          tabindex: '-1',
                          onClick: () => r.handleSkinClick(n),
                          onMouseEnter: () => r.handleSkinMouseOver(n),
                          onMouseLeave: () => r.handleSkinMouseOver(),
                          class: 'option flex flex-grow flex-middle',
                          children: [
                            de('span', { class: 'skin-tone skin-tone-'.concat(n) }),
                            de('span', { class: 'margin-small-lr', children: xe.skins[n] }),
                          ],
                        }),
                      ],
                    });
              ...
              return de('section', {
                ...
                style: {
                  width: this.props.dynamicWidth
                    ? '100%'
                    : 'calc('.concat(e, 'px + (var(--padding) + var(--sidebar-width)))'),
                },
                ...
                children: [
                  ...
                  'sticky' == this.props.searchPosition &&
                    de('div', { class: 'padding-lr', children: this.renderSearch() }),
                  de('div', {
                    ...
                    children: de('div', {
                      ...
                      children: [
                        'static' == this.props.searchPosition && this.renderSearch(),
