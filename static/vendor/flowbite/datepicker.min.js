var Datepicker = (() => {
  ...
  const w = {};
  const k = {
      y: (e, t) => new Date(e).setFullYear(Number.parseInt(t, 10)),
      m(e, t, i) {
        const r = new Date(e);
        let a = Number.parseInt(t, 10) - 1;
        if (isNaN(a)) {
          if (!t) return Number.NaN;
          const e = t.toLowerCase(),
            r = t => t.toLowerCase().startsWith(e);
          if (((a = i.monthsShort.findIndex(r)) < 0 && (a = i.months.findIndex(r)), a < 0)) return Number.NaN;
        }
        return (
          r.setMonth(a),
          r.getMonth() !==
      ...
      d: (e, t) => new Date(e).setDate(Number.parseInt(t, 10)),
    },
    v = {
      d: e => e.getDate(),
      dd: e => x(e.getDate(), 2),
  ...
  function D(e) {
    ...
    const a = r.map(e => v[e]),
      s = Object.keys(k).reduce((e, t) => {
        return r.find(e => 'D' !== e[0] && e[0].toLowerCase() === t) && e.push(t), e;
      }, []);
    return (w[e] = {
      parser(e, t) {
      ...
      formatter: (e, r) => a.reduce((t, a, s) => t + `${i[s]}${a(e, r)}`, '') + t(i),
    });
  }
  function M(e, t, i) {
    ...
    if (e) {
      ...
      return D(t).parser(e, i);
    }
  }
  function S(e, t, i) {
    if (isNaN(e) || (!e && 0 !== e)) return '';
    const r = 'number' == typeof e ? new Date(e) : e;
    return t.toDisplay ? t.toDisplay(r, t, i) : D(t).formatter(r, i);
  }
  const C = new WeakMap(),
  ...
  if (!Event.prototype.composedPath) {
    const e = (t, i = []) => {
      ...
      return (
        i.push(t),
        t.parentNode ? (r = t.parentNode) : t.host ? (r = t.host) : t.defaultView && (r = t.defaultView),
        r ? e(r, i) : i
      );
    };
  ...
  const { language: H, format: T, weekStart: j } = N;
  function $(e, t) {
  ...
  function q(t, r) {
    ...
    if (a.language) {
      ...
      if (
        (a.language !== o &&
          (n[a.language] ? (e = a.language) : void 0 === n[(e = a.language.split('-')[0])] && (e = !1)),
        delete a.language,
        e)
      ) {
        o = s.language = e;
        const t = c || n[H];
        (c = Object.assign({ format: T, weekStart: j }, n[H])),
          o !== H && Object.assign(c, n[o]),
          (s.locale = c),
          d === t.format && (d = s.format = c.format),
          m === t.weekStart && ((m = s.weekStart = c.weekStart), (s.weekEnd = _(c.weekStart)));
      }
    }
    if (a.format) {
    ...
    let y = g,
      w = h;
    if (
      (void 0 !== a.minDate && ((y = null === a.minDate ? l(0, 0, 1) : I(a.minDate, d, c, y)), delete a.minDate),
      void 0 !== a.maxDate && ((w = null === a.maxDate ? void 0 : I(a.maxDate, d, c, w)), delete a.maxDate),
      w < y
    ...
    if (void 0 !== a.weekStart) {
      ...
      isNaN(e) || ((m = s.weekStart = e), (s.weekEnd = _(e))), delete a.weekStart;
    }
    if (
      (a.daysOfWeekDisabled &&
        ((s.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce($, [])), delete a.daysOfWeekDisabled),
      a.daysOfWeekHighlighted &&
        ((s.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce($, [])), delete a.daysOfWeekHighlighted),
      void 0 !== a.maxNumberOfDates)
    ) {
      const e = Number.parseInt(a.maxNumberOfDates, 10);
      e >= 0 && ((s.maxNumberOfDates = e), (s.multidate = 1 !== e)), delete a.maxNumberOfDates;
    }
    a.dateDelimiter && ((s.dateDelimiter = String(a.dateDelimiter)), delete a.dateDelimiter);
    let k = f;
    void 0 !== a.pickLevel && ((k = P(a.pickLevel, 2)), delete a.pickLevel), k !== f && (f = s.pickLevel = k);
    let v = u;
    void 0 !== a.maxView && ((v = P(a.maxView, u)), delete a.maxView), (v = f > v ? f : v) !== u && (u = s.maxView = v);
    let x = p;
    if (
      (void 0 !== a.startView && ((x = P(a.startView, x)), delete a.startView),
      x < f ? (x = f) : x > u && (x = u),
      x !== p && (s.startView = x),
      a.prevArrow)
    ) {
      const e = A(a.prevArrow);
      e.childNodes.length > 0 && (s.prevArrow = e.childNodes), delete a.prevArrow;
    }
    if (a.nextArrow) {
      const e = A(a.nextArrow);
      e.childNodes.length > 0 && (s.nextArrow = e.childNodes), delete a.nextArrow;
    }
    if (
      (void 0 !== a.disableTouchKeyboard &&
        ((s.disableTouchKeyboard = 'ontouchstart' in document && !!a.disableTouchKeyboard),
  ...
  class z {
    constructor(e, t) {
      Object.assign(this, t, {
        picker: e,
        element: A('<div class="datepicker-view flex"></div>').firstChild,
        selected: [],
      }),
  ...
  class X extends z {
    ...
    updateFocus() {
      ...
      (this.first = r), (this.last = l(t, i + 1, 0)), (this.start = a), (this.focused = this.picker.viewDate);
    }
    updateSelection() {
    ...
    render() {
      ...
      Array.from(this.grid.children).forEach((e, t) => {
        ...
        if (
          ...
          a < this.first
            ? r.add('prev', 'text-gray-500', 'dark:text-white')
            : a > this.last && r.add('next', 'text-gray-500', 'dark:text-white'),
          this.today === a && r.add('today', 'bg-gray-100', 'dark:bg-gray-600'),
          (a < this.minDate || a > this.maxDate || this.disabled.includes(a)) &&
            r.add('disabled', 'cursor-not-allowed'),
          this.daysOfWeekDisabled.includes(n) && (r.add('disabled', 'cursor-not-allowed'), i(this.disabled, a)),
          ...
          a > e &&
            a < t &&
            (r.add('range', 'bg-gray-200', 'dark:bg-gray-600'), r.remove('rounded-lg', 'rounded-l-lg', 'rounded-r-lg')),
            a === e &&
              (r.add('range-start', 'bg-gray-100', 'dark:bg-gray-600', 'rounded-l-lg'),
              r.remove('rounded-lg', 'rounded-r-lg')),
            a === t &&
              (r.add('range-end', 'bg-gray-100', 'dark:bg-gray-600', 'rounded-r-lg'),
  ...
  class Q extends z {
    ...
    init(e, t = !0) {
      t &&
        ...
        this.grid.appendChild(A(n('span', 12, { 'data-month': e => e })))),
        super.init(e);
    }
    setOptions(t) {
    ...
    render() {
      ...
      Array.from(this.grid.children).forEach((s, n) => {
        ...
        if (
          ...
          (t || (i && n < this.minMonth) || (r && n > this.maxMonth)) && d.add('disabled'),
          a)
        ) {
          const [e, t] = a;
  ...
  class Z extends z {
    ...
    init(e, t = !0) {
      ...
      t &&
        ...
        this.grid.appendChild(A(n('span', 12)))),
        super.init(e);
    }
    setOptions(t) {
      if (
  ...
  function se(t, i) {
    ...
    if (
      (i.locale &&
        ((t.controls.todayBtn.textContent = i.locale.today), (t.controls.clearBtn.textContent = i.locale.clear)),
      void 0 !== i.todayBtn && (i.todayBtn ? W(t.controls.todayBtn) : Y(t.controls.todayBtn)),
  ...
  function de(e, t) {
    ...
    switch (
      ...
      r.getMonth() !== i.getMonth() && ee(e.datepicker, 'changeMonth'),
      a)
    ) {
      case 0:
        return t < n || t > d;
  ...
  class ce {
    constructor(e) {
      ...
      const t = J.replace(/%buttonClass%/g, e.config.buttonClass),
        ...
        g = { title: n, prevBtn: d, viewSwitch: o, nextBtn: l, todayBtn: h, clearBtn: u };
      (this.main = a), (this.controls = g);
      const f = e.inline ? 'inline' : 'dropdown';
      i.classList.add(`datepicker-${f}`),
        'dropdown' === f && i.classList.add('dropdown', 'absolute', 'top-0', 'left-0', 'z-50', 'pt-2'),
        se(this, e.config),
        (this.viewDate = ne(e)),
        F(e, [
          [
          ...
          [
            ...
            ((e, t) => {
              ...
              a ? e.setDate(Number(i.dataset.date)) : ae(e, 1 === r ? Number(i.dataset.month) : Number(i.dataset.year));
            }).bind(null, e),
          ],
          [
            g.viewSwitch,
    ...
    show() {
      ...
      if (!e.inline) {
        ...
        t !== oe(e.config.container) ? (this.element.dir = t) : this.element.dir && this.element.removeAttribute('dir'),
          this.place(),
    ...
    place() {
      ...
      a === document.body
        ...
        'auto' === b &&
          (p < 0 ? ((b = 'left'), (p = 10)) : (b = p + s > c ? 'right' : 'rtl' === oe(r) ? 'right' : 'left')),
        'right' === b && (p -= s - u),
  ...
  function le(e, t, i, r) {
    ...
    switch (n.id) {
      case 0:
        (l = r ? h(l, 7 * i) : t.ctrlKey || t.metaKey ? g(l, i) : h(l, i)), (o = h), (c = e => n.disabled.includes(e));
        break;
      case 1:
        (l = u(l, r ? 4 * i : i)),
          (o = u),
        ...
        break;
      default:
        (l = g(l, i * (r ? 4 : 1) * d)), (o = g), (c = e => n.disabled.includes(m(e, d)));
    }
    void 0 !==
      (l = (function e(t, i, r, s, n, d) {
        if (a(t, n, d)) return s(t) ? e(i(t, r), i, r, s, n, d) : t;
      })(l, o, i < 0 ? -d : d, c, n.minDate, n.maxDate)) && s.changeFocus(l).render();
  }
  function he(e, t) {
  ...
  function ue(e, t, i = !1) {
    ...
    return 0 !== o.length
      ? (r.multidate &&
        ...
        r.maxNumberOfDates && o.length > r.maxNumberOfDates ? o.slice(-1 * r.maxNumberOfDates) : o)
      : void 0;
  }
  function ge(e, t = 3, i = !0) {
    const { config: r, picker: a, inputField: s } = e;
    if (2 & t) {
      const e = a.active ? r.pickLevel : r.startView;
      a.update().changeView(e).render(i);
    }
    1 & t && s && (s.value = he(e.dates, r));
  }
  function fe(e, t, i) {
    let { clear: r, render: a, autohide: s } = i;
    void 0 === a && (a = !0), a ? void 0 === s && (s = e.config.autohide) : (s = !1);
    const n = ue(e, t, r);
    n &&
      (n.toString() !== e.dates.toString() ? ((e.dates = n), ge(e, a ? 3 : 1), ee(e, 'changeDate')) : ge(e, 1),
      s && e.hide());
  }
  return class {
    constructor(e, t = {}, i) {
      ...
      this.dates = [];
      const o = ue(this, d);
      o && o.length > 0 && (this.dates = o), n && (n.value = he(this.dates, a));
    ...
    setOptions(e) {
      const t = this.picker,
        i = q(e, this);
      Object.assign(this._options, e), Object.assign(this.config, i), t.setOptions(i), ge(this, 3);
    }
    show() {
      if (this.inputField) {
    ...
    setDate(...e) {
      const i = [...e],
        r = {},
        a = t(e);
      'object' != typeof a || Array.isArray(a) || a instanceof Date || !a || Object.assign(r, i.pop()),
        fe(this, Array.isArray(i[0]) ? i[0] : i, r);
    }
    update(e) {
      if (this.inline) return;
      const t = { clear: !0, autohide: !(!e || !e.autohide) };
      fe(this, r(this.inputField.value, this.config.dateDelimiter), t);
    }
    refresh(e, t = !1) {
      let i;
      e && 'string' != typeof e && ((t = e), (e = void 0)),
        ge(this, (i = 'picker' === e ? 2 : 'input' === e ? 1 : 3), !t);
    }
    enterEditMode() {
      this.inline ||
        !this.picker.active ||
