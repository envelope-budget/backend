((e, t) => {
  ...
  (() => {
    ...
    var i = w.map(e => '[hx-' + e + '], [data-hx-' + e + ']').join(', ');
    var S = e('head'),
      q = e('title'),
      H = e('svg', true);
    function e(e, t) {
    ...
    function l(e) {
      ...
      if (Q.config.useTemplateFragments && t) {
        ...
        if (Q.config.allowScriptTags) {
          oe(a.querySelectorAll('script'), e => {
    ...
    function gt() {
      if (!dt) {
        ...
        setInterval(() => {
          if (vt) {
            vt = false;
            oe(re().querySelectorAll("[hx-trigger='revealed'],[data-hx-trigger='revealed']"), e => {
              pt(e);
            });
          }
        }, 200);
    ...
    function Lt(n, e, t, r) {
      if (e.sseEvent) {
        ...
        if (e.threshold) {
          i.threshold = Number.parseFloat(e.threshold);
        }
