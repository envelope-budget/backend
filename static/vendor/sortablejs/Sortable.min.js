...
!((t, e) => {
      ...
      if ((e || n) && t !== window && ((i = i || t.parentNode), !y))
        do {
          if (i && i.getBoundingClientRect && ('none' !== R(i, 'transform') || (n && 'static' !== R(i, 'position')))) {
            ...
            (a -= h.top + Number.parseInt(R(i, 'border-top-width'))),
              (l -= h.left + Number.parseInt(R(i, 'border-left-width'))),
              (s = a + r.height),
              (c = l + r.width);
            break;
          }
          ...
          s && ((i.top -= s.f), (i.left -= s.e)),
            ...
            n.thisAnimationDuration &&
              ...
              (e =
                ...
                a.animation)),
            S(i, o) ||
              ((n.prevFromRect = o), (n.prevToRect = i), (e = e || this.options.animation), this.animate(n, l, i, e)),
            e &&
              ((u = !0),
              (d = Math.max(d, e)),
  ...
  var Z,
    ...
    kt = (t, e) => {
      var n = R(t),
        o =
          Number.parseInt(n.width) -
          Number.parseInt(n.paddingLeft) -
          Number.parseInt(n.paddingRight) -
          Number.parseInt(n.borderLeftWidth) -
          Number.parseInt(n.borderRightWidth),
        i = B(t, 0, e),
        r = B(t, 1, e),
        a = i && R(i),
        l = r && R(r),
        s = a && Number.parseInt(a.marginLeft) + Number.parseInt(a.marginRight) + X(i).width,
        t = l && Number.parseInt(l.marginLeft) + Number.parseInt(l.marginRight) + X(r).width;
      if ('flex' === n.display)
  ...
  (jt.prototype = {
        ...
        if (
          ...
          if (((it = j(l)), (at = j(l, t.draggable)), 'function' == typeof c)) {
            if (c.call(this, e, l, this))
              return (
                V({ sortable: this, rootEl: s, name: 'filter', targetEl: l, toEl: o, fromEl: o }),
                U('filter', this, { evt: e }),
            ...
            (c =
              ...
              c.split(',').some(t => {
                if ((t = P(s, t.trim(), o, !1)))
                  return (
                    V({ sortable: this, rootEl: t, name: 'filter', targetEl: l, fromEl: o, toEl: o }),
                    U('filter', this, { evt: e }),
                    !0
                  );
              }))
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        (o = () => {
          U('delayEnded', this, { evt: t }),
            jt.eventCanceled
              ? this._onDrop()
              : (this._disableDelayedDragEvents(),
                !s && this.nativeDraggable && (Z.draggable = !0),
                this._triggerDragStart(t, e),
                V({ sortable: this, name: 'choose', originalEvent: t }),
                k(Z, a.chosenClass, !0));
        }),
        ...
        h(l, 'touchmove', Bt),
        a.supportPointer
          ? (h(l, 'pointerup', this._onDrop), this.nativeDraggable || h(l, 'pointercancel', this._onDrop))
          : (h(l, 'mouseup', this._onDrop), h(l, 'touchend', this._onDrop), h(l, 'touchcancel', this._onDrop)),
        ...
        !a.delay || (a.delayOnTouchOnly && !e) || (this.nativeDraggable && (w || y))
          ...
          : jt.eventCanceled
            ? this._onDrop()
            : (a.supportPointer
                ? (h(l, 'pointerup', this._disableDelayedDrag), h(l, 'pointercancel', this._disableDelayedDrag))
                : (h(l, 'mouseup', this._disableDelayedDrag),
                  h(l, 'touchend', this._disableDelayedDrag),
                  h(l, 'touchcancel', this._disableDelayedDrag)),
              h(l, 'mousemove', this._delayedDragTouchMoveHandler),
              h(l, 'touchmove', this._delayedDragTouchMoveHandler),
              a.supportPointer && h(l, 'pointermove', this._delayedDragTouchMoveHandler),
      ...
      if (!Q) {
        ...
        k((Q = Z.cloneNode(!0)), n.ghostClass, !1),
          ...
          R(
            Q,
            'transform-origin',
            (ft / Number.parseInt(Q.style.width)) * 100 + '% ' + (gt / Number.parseInt(Q.style.height)) * 100 + '%'
          );
      }
    },
        ...
        jt.eventCanceled
          ...
          : (U('setupClone', this),
            ...
            (this.cloneId = Wt(() => {
              U('clone', this),
                jt.eventCanceled ||
                  (this.options.removeCloneOnHide || J.insertBefore(nt, Z),
                  this._hideClone(),
                  V({ sortable: this, name: 'clone' }));
            })),
            e || k(Z, i.dragClass, !0),
            e
              ? ((Et = !0), (this._loopId = setInterval(this._emulateDragOver, 50)))
              : (p(document, 'mouseup', this._onDrop),
                p(document, 'touchend', this._onDrop),
                p(document, 'touchcancel', this._onDrop),
                o && ((o.effectAllowed = 'move'), i.setData && i.setData.call(this, o, Z)),
                h(document, 'drop', this),
                R(Z, 'transform', 'translateZ(0)')),
            (Dt = !0),
            (this._dragStartId = Wt(this._dragStarted.bind(this, e, t))),
          ...
          I(
            {
              ...
              target: l,
              completed: A,
              onMove: (t, e) => Ht(J, a, Z, o, t, X(t), n, e),
              changed: N,
            },
            e
          )
    ...
    destroy: function () {
      ...
      (t[K] = null),
        ...
        Array.prototype.forEach.call(t.querySelectorAll('[draggable]'), t => {
    ...
    (jt.mount = () => {
      ...
      (e = e[0].constructor === Array ? e[0] : e).forEach(t => {
                  ...
                  ? (oe(e, this.options, t, n),
                    ...
                    !Jt ||
                      ...
                      ($t = setInterval(() => {
                        ...
                        t !== o && ((o = t), te()), oe(e, this.options, t, n);
                      }, 10)),
                      (qt = r),
                      (Vt = a)))
    ...
    jt.mount(
      new (function () {
        ...
        return (
          ...
          a(t, { pluginName: 'swap', eventProperties: () => ({ swapItem: ne }) })
        );
      })()
    ),
    jt.mount(
          ...
          (t.prototype = {
            ...
            dragStartGlobal: function (t) {
              ...
              !this.isMultiDrag && le && le.multiDrag._deselectMultiDrag(),
                ...
                (de = de.sort((t, e) => t.sortableIndex - e.sortableIndex)),
                (ge = !0);
            },
            dragStarted: function (t) {
              var e,
                                ...
                                ~de.indexOf(i[e]) ||
                                  (P(i[e], o.draggable, u, !1) &&
                                    ((n &&
                                      ('function' == typeof n
                                        ? n.call(d, s, i[e], d)
                                        : n.split(',').some(t => P(i[e], t.trim(), u, !1)))) ||
              ...
              return (
                de.forEach(t => {
                  ...
                  o.push({ multiDragElement: t, index: t.sortableIndex }),
                    (e = fe && t !== se ? -1 : fe ? j(t, ':not(.' + this.options.selectedClass + ')') : j(t)),
