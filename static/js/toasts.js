function showToast(message) {
  ...
  toast.className = 'flex items-center p-4 mb-3 rounded-lg bg-gray-50 dark:bg-gray-800';
  ...
  toast.innerHTML = `
    ...
    <div class="ms-3 text-sm font-medium text-gray-800 dark:text-gray-300">${message}</div>
    <button type="button"
